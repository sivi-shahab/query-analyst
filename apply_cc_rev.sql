...
case when card_blk_code = '' and card_prv_blk_code = 'ni' THEN TRY_CAST(CAST(card_dte_blk_code AS VARCHAR) AS DATE
     WHEN card_blk_code = '' AND card_prv_blk_code = '' THEN TRY_CAST(CAST(card_dte_blk_code AS VARCHAR) AS DATE)
	 ELSE NULL
